...
/**
 * Suggest the value which is the result of the [suggestionBuilder].
 * Additionally, a separate tooltip associated with the suggestion
 ...
 * Suggest the entries of the iterable which is the result of the
 * [suggestionsBuilder].
 * Additionally, a separate tooltip associated with each suggestion
 * will be shown as well.
 */
...
@PublishedApi
internal fun SuggestionsBuilder.applyIterable(iterable: Iterable<Any?>?) = iterable?.forEach(::applyAny)
