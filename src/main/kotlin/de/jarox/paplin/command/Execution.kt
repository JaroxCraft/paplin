 ...
 */
inline infix fun ArgumentBuilder<CommandSourceStack, *>.runs(crossinline executor: CommandContext.() -> Unit) =
    this.apply {
        executes wrapped@{
...
inline infix fun ArgumentBuilder<CommandSourceStack, *>.simpleExecutes(crossinline executor: CommandContext.() -> Unit) = runs(executor)
